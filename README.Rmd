...
Another useful function in regexcite is `my_add()`. This function adds two numbers (x,y) together. It returns `NA` if either parameter is `NA` and uses a default value of 10 for y.
